...
<title>INCOME2017 | General information</title>
...
<meta property="og:url" content="http://income2017.saske.sk/information"/>
...
<meta property="twitter:url" content="http://income2017.saske.sk/information"/>
<meta property="twitter:site" content="@income2017"/>

<link rel="canonical" href="http://income2017.saske.sk/information" />
...
<div id="navigation" class="fixed w3-container">
  ...
  <ul class="navigation w3-navbar w3-large">
    ...
    <ul class="w3-right">
      ...
      <li><a class="selected" href="/information">General information</a></li>
...
<div id="main" class="w3-container">
  ...
  <div class="w3-row">
    <div id="instructions" class="section left w3-half">
      ...
      <h3>For authors</h3>
      <ul class="w3-ul w3-margin-left">
        <li><p class="error message w3-center" style="margin-top:0">Abstract submission is closed!<span onclick="toggleAbstract()" class="abstract-toggler w3-closebtn"><i class="fa fa-angle-down"></i></span></p></li>
        <li class="abstract">The abstract (one page, English) has to be prepared according to this <a href="misc/INCOME2017_AbstractTemplate.docx">template</a>.</li>
        <li class="abstract">The authors are responsible for the text of their abstracts and their appropriate graphical design. The abstract which does not meet the given <a href="misc/INCOME2017_AbstractTemplate.docx">template</a> will not be accepted and its author will be notified.</li>
        <li class="abstract">All abstracts will be published in the Book of Abstracts.</li>
        <li class="abstract w3-center"><a href="misc/INCOME2017_AbstractTemplate.docx" class="download w3-btn"><i class="fa fa-file-word-o"></i> Template</a></li>
        <li class="abstract" style="margin-bottom:15px">The abstracts have to be submitted electronically to the following e-mail address: <a href="mailto:income2017@saske.sk">income2017@saske.sk</a></li>
        <li><p class="info message w3-center" style="margin-top:0">Manuscript submission is open!</p></li>
        <li>Participants of <span class="in">I</span><span class="in">N</span><span class="co">C</span><span class="co">O</span><span class="me">M</span><span class="me">E</span>2017 have a possibility to submit their manuscript in a forthcoming Focus Issue of the <a href="http://www.springer.com/materials/journal/10853" target="_blank">Journal of Materials Science</a> (Springer), devoted to mechanochemical synthesis and reactions in materials science. The goal of this focus issue is to provide the materials science community, with acomprehensive overview on mechanochemical effects in materials synthesis, structure and properties. Submission is opened to manuscripts in every aspect of mechanochemistry, and mechanical activation, including fundamentals and methods, applications, emerging opportunities, and challenges.</li>
        <li>Please, follow the guidelines provided in the <a href="misc/JMS_InstructionsForAuthors.pdf" target="_blank">Instructions for Authors</a> when preparing your manuscript; to upload your files, please log in to the <a href="https://www.editorialmanager.com/jmsc/default.aspx" target="_blank">Editorial Manager</a> system of the journal, and when prompted with the menu "Article Type", select the option "Special: Mechanochemical Synthesis 2017". The deadline is February 1, 2018. Please note that the journal will only publish original full-length articles; submissions that look like conference proceedings, will be rejected without being sent out for review. Review papers on the subject, are also welcome.</li>
      </ul>
    </div>
    <div id="informations" class="section right w3-half">
    ...
    <div id="important-dates" class="section left w3-half">
      ...
      <ul class="deadlines w3-ul">
        ...
        <li><span class="deadline w3-left">Deadline for manuscript submission</span> <br /> 01.02.2018</li>
      </ul>
    </div>
    <div id="contact" class="section right w3-half">
      <h1><i class="fa fa-envelope-o icon"></i> Contact</h1>
      <h3>Organizers of <span class="in">I</span><span class="in">N</span><span class="co">C</span><span class="co">O</span><span class="me">M</span><span class="me">E</span>2017</h3>
      <ul class="w3-ul w3-margin-left" itemscope="" itemtype="http://schema.org/PostalAddress">
        <li itemprop="address"><div class="fa fa-map-marker icon"></div> Watsonova 45, 040 01 Košice, Slovakia</li>
        <li itemprop="email"><div class="fa fa-envelope icon"></div> <a href="mailto:income2017@saske.sk">income2017@saske.sk</a> <!-- general queries--></li>
